...
public class Sanitizador {
	...
	/** Devuelve una expresiï¿½n "sana" de entrada.
...
//	}
	 ...
	 * SQL, reemplazï¿½ndolas por dobles.
	 ...
	 * los caracteres no numï¿½ricos y devolviendo un {@link Integer}.
	 * @param entrada El string a sanitizar.
	...
	static public Integer sanitizar_integer(Object entrada) {
	 ...
	 try {
		...
		// Si no es un nï¿½mero no hacemos nada, devolvemos null.
	 }
	...
	/** Sanitiza un objeto que es realmente un string eliminando
	 * los caracteres no numï¿½ricos y devolviendo un int .
	 * @param entrada El string a sanitizar.
