...
public class PantallaVencimientosOrd extends PantallaInicio {
	
private LinkedList<DatosProducto> datos_prod;
private WidgetMostrarVencimientosOrd vencimientos;
...
//boolean tildado= false;
	...
	public PantallaVencimientosOrd() {
		super();
	}
...
//		agregar_prod= new WidgetAgregarProducto(this, null);	
		...
		vencimientos= new WidgetMostrarVencimientosOrd(datos_prod, "Vencimientos", this);
